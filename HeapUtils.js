var HeapUtils = {
    inputNumber : function () {
        ...
        if (num == null)return HeapUtils.inputNumber();
        else return num;
    },

    inputNumber : function(str) {
        var num = prompt(str,42);
        if(num==null)return HeapUtils.inputNumber(str);
        else return num;
    },
    ...
    getAnswerID : function(){
        //alert('answer'+HeapUtils.getQuestionID());
        return 'answer'+HeapUtils.getQuestionID();
    },
